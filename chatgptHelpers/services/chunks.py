...
import uuid
from chatgptHelpers.models.models import Document, DocumentChunk, DocumentChunkMetadata

import tiktoken
import time


# from ..services import openaiwrapper 
from chatgptHelpers.services.openaiwrapper import get_embeddings
...
MIN_CHUNK_LENGTH_TO_EMBED = 25  # Discard chunks shorter than this
EMBEDDINGS_BATCH_SIZE = 10  # The number of embeddings to request at a time
...
def get_document_chunks(
    ...
    for i in range(0, len(all_chunks), EMBEDDINGS_BATCH_SIZE):
        print(f"Currently at embedding {i} of {len(all_chunks)}. Waiting to avoid rate limiting...")
        #     time.sleep(60)
